...
# creating window
main = Tk()
main.resizable(0, 0)  # resizing window disabled
...
entry_init.set('0')
entry = Entry(main, textvariable=entry_init, width=30, borderwidth=10, font=but_font, justify=RIGHT)  # xadługi text
...
# creating buttons
button_eq = Button(main, text='=', width=30, font=but_font, fg='#0064C8', activeforeground='red', command=lambda: eq())  # lambda a bez lambdy
...
button_clear = Button(main, text='Clear', width=6, height=3, font=but_font, command=lambda: clear())
